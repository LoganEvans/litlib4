...
Laplace expansion for 4x4 matrices over any commutative ring.
-/
...
-- ============================================================================
-- THE 4x4 DETERMINANT THEOREM (GENERALIZED)
-- ============================================================================
...
lemma expand_det_4 {R : Type*} [CommRing R] (M : Matrix (Fin 4) (Fin 4) R) :
  ...
  change (-1 : R) ^ 0 * M 0 0 * (M.submatrix Fin.succ (Fin.succAbove 0)).det +
         ((-1 : R) ^ 1 * M 0 1 * (M.submatrix Fin.succ (Fin.succAbove 1)).det +
         ((-1 : R) ^ 2 * M 0 2 * (M.submatrix Fin.succ (Fin.succAbove 2)).det +
         ((-1 : R) ^ 3 * M 0 3 * (M.submatrix Fin.succ (Fin.succAbove 3)).det +
         0))) = _
