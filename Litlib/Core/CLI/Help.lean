...
def printHelp : IO UInt32 := do
  ...
  IO.println "                           papers, equations, and standalone theorems."
  ...
  IO.println ""
  IO.println "  --theorem[=GLOBS]        Filter by standalone theorem names."
  ...
  IO.println "      via `Litlib.theorem` or `Litlib.equation`."
